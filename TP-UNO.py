...
def registrar_usuario():
    ...
    while len(nombre.strip()) == 0:       #strip() elimina los espacios en blanco al inicio y al final de la cadena, len() devuelve la cantidad de caracteres de la cadena, sirve para validar que el nombre no este vacio o que no tenga espacios en blanco
...
def reglas():
    ...
    print("5. El primer jugador en quedarse sin cartas gana")
